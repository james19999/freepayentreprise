...
class EditSlider extends ConsumerStatefulWidget {
  final Sliders slider;
  const EditSlider({super.key, required this.slider});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _EditSliderState();
}

class _EditSliderState extends ConsumerState<EditSlider> {
  ...
  void initState() {
    super.initState();
    _controllername.text = widget.slider.description;
  }
                ...
                child: TextButton.icon(
                    onPressed: () async {
                      if (_key.currentState!.validate()) {
                        var check = await controller.UpdateSlider(
                            _controllername.text, _image!, widget.slider.id);
                        if (check == true) {
                          Toas.getSnackbarsucess(appName, "Slider modifié");
