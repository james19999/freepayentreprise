...
class AddPromotion extends ConsumerStatefulWidget {
  const AddPromotion({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _AddPromotionState();
}

class _AddPromotionState extends ConsumerState<AddPromotion> {
