...
class AddPub extends ConsumerStatefulWidget {
  const AddPub({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _AddPubState();
}

class _AddPubState extends ConsumerState<AddPub> {
            ...
            child: Padding(
              ...
              child: Container(
                  ...
                  child: TextButton.icon(
                      onPressed: () async {
                        var check = await controller.AddPub(_image!);
                        if (check == true) {
                          Toas.getSnackbarsucess(
                              appName, "Produit mise en avant");
                          controller.getPub();
                          Get.off(() => PubList());
                        } else {
                          Toas.getSnackbarEror(
                              appName, "Erreur de créaction .");
                        }
                      },
                      icon: Icon(
                        Icons.add,
