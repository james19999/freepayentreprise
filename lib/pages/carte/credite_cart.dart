...
class CreditCart extends ConsumerStatefulWidget {
  const CreditCart({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _CreditCartState();
}

class _CreditCartState extends ConsumerState<CreditCart> {
